...
var states = [
        ...
        { name: 'alerts', state: { url: '/alerts', parent: 'dashboard', templateUrl: 'views/dashboard/alerts.html', controller: 'AlertCtrl', data: {text: "Alerts", visible: true } } },
...
angular.module('yapp', [
        ...
        .config(function($stateProvider, $urlRouterProvider) {
            $urlRouterProvider.when('/dashboard', '/dashboard/instance');
